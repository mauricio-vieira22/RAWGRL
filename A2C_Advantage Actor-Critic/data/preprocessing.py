...
from data.pipeline_preprocesamiento.step1_crear_dataset import crear_dataset
from data.pipeline_preprocesamiento.step2_gain_e_imputer import agregar_gain, imputer, ALL_BANDAS, ALL_ANTENAS
from data.pipeline_preprocesamiento.step3_mapear_a_blocks import mapear_a_blocks
from data.pipeline_preprocesamiento.step4_block_to_distribution import blocks_to_distributions
...
def run_pipeline(
    ...
    rssi_fill:      float       = np.nan,  # __v0.5__: NaN en lugar de -inf
