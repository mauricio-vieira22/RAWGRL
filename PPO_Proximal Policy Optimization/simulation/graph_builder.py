...
- $\mathcal{V}_C$: Conjunto de Nodos de Clientes (Estaciones).
...
conocimiento sobre el estado oculto del POMDP, estabilizando el aprendizaje del Actor-Critic.
...
def construir_grafo_timestep(
    ...
    data['client', 'connected_to', 'ap'].edge_index = torch.stack(
        [local_idx, ap_activos], dim=0
    )
