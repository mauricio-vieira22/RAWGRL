r"""
evaluate.py — Inferencia Empírica y Evaluación de Políticas (NetROML — A2C).

Este módulo ejecuta la política Actor $\pi_{\theta^*}$ pre-entrenada del A2C
...
def run_episode(
    ...
    with torch.no_grad():
        while not done:
            ...
            # A2C GNN retorna (ch_logits, pwr_logits, value)
